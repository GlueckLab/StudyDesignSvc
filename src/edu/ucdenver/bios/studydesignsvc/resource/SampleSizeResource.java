 ...
 * domain list object of a Sample Size. 
...
public interface SampleSizeResource
{
     ...
     */  
    @Post
    public List<SampleSize> create(byte[] uuid,List<SampleSize> list);
     ...
     */    
    @Put
    public List<SampleSize> update(byte[] uuid,List<SampleSize> list);
