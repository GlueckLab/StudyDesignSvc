...
public class BetweenParticipantServerResource implements BetweenParticipantResource 
{
     ...
     */
	@Get("json")
	public List<BetweenParticipantFactor> retrieve(byte[] uuid) 
	{
		...
		try
		{
			...
			studyDesignManager.beginTransaction();												
            	...
            	{		
					...
					if(studyDesign!=null)
						betweenParticipantFactorList = studyDesign.getBetweenParticipantFactorList();					
            	}				
		...
		catch(StudyDesignException sde)
		{
			...
			if(studyDesignManager!=null)
			{
				...
				catch(BaseManagerException re) {betweenParticipantFactorList = null;}					
			}
			betweenParticipantFactorList = null;
		}								
     ...
     */
	@Post("json")
	public List<BetweenParticipantFactor> create(byte[] uuid,List<BetweenParticipantFactor> betweenParticipantFactorList) 
	{		
		...
		try
		{
			 ...
			 * ----------------------------------------------------*/
			if(uuidFlag && studyDesign.getBetweenParticipantFactorList()!=null)
				removeFrom(studyDesign);	
			/* ----------------------------------------------------
			 * Set reference of Study Design Object to each Between Participant element 
			 * ----------------------------------------------------*/	
			...
			/* ----------------------------------------------------
			 * Save new Between Participant Effects object 
			 * ----------------------------------------------------*/
			if(uuidFlag)
			{	
				...
				betweenParticipantFactorManager.beginTransaction();
					betweenParticipantFactorManager.saveOrUpdate(betweenParticipantFactorList, true);
				betweenParticipantFactorManager.commit();*/
				/* ----------------------------------------------------
    			 * Set reference of Power Curve Object to Study Design object 
    			 * ----------------------------------------------------*/
            	studyDesign.setBetweenParticipantFactorList(betweenParticipantFactorList);            	
            	studyDesignManager = new StudyDesignManager();
            	studyDesignManager.beginTransaction();            		
     ...
     */
	@Put("json")
	public List<BetweenParticipantFactor> update(byte[] uuid,List<BetweenParticipantFactor> betweenParticipantFactorList) 
	{				
     ...
     */
	@Delete("json")
	public List<BetweenParticipantFactor> remove(byte[] uuid) 
	{
		List<BetweenParticipantFactor> betweenParticipantFactorList = null;
		StudyDesign studyDesign = null;
		try
		{
			...
			studyDesignManager.beginTransaction();								
            	...
            	{		
					...
					if(studyDesign!=null)
						betweenParticipantFactorList = studyDesign.getBetweenParticipantFactorList();
					/*if(betweenParticipantFactorList.isEmpty())
						throw new ResourceException(Status.CLIENT_ERROR_BAD_REQUEST, 
								"no TypeIError is specified");*/					
            	}				
			studyDesignManager.commit();
			/* ----------------------------------------------------
			 * Remove existing Between Participant objects for this object 
			 * ----------------------------------------------------*/
			if(studyDesign.getBetweenParticipantFactorList()!=null)
			{
				betweenParticipantFactorManager = new BetweenParticipantFactorManager();
				betweenParticipantFactorManager.beginTransaction();
					betweenParticipantFactorList = betweenParticipantFactorManager.delete(uuid,betweenParticipantFactorList);
					betweenParticipantFactorManager.commit();
			}
		}
		catch (BaseManagerException bme)
     ...
     */
	@Delete("json")
	public List<BetweenParticipantFactor> removeFrom(StudyDesign studyDesign) 
	{	
		List<BetweenParticipantFactor> betweenParticipantFactorList = null;	
        try
        {                    			
        	betweenParticipantFactorManager = new BetweenParticipantFactorManager();
        	betweenParticipantFactorManager.beginTransaction();
        	betweenParticipantFactorList=betweenParticipantFactorManager.delete(studyDesign.getUuid(),studyDesign.getBetweenParticipantFactorList());
        	betweenParticipantFactorManager.commit();
        	/* ----------------------------------------------------
			 * Set reference of BetweenParticipantFactor Object to Study Design object 
			 * ----------------------------------------------------*/
        ...
        catch (BaseManagerException bme)
        {
            ...
            if (betweenParticipantFactorManager != null) try { betweenParticipantFactorManager.rollback(); } catch (BaseManagerException e) {}
            betweenParticipantFactorList = null;           
        }
        /*catch (StudyDesignException sde)
        {
