...
implements CategoryResource 
{
	...
	public List<Category> retrieve(byte[] uuid) 
	{
		...
		catch(StudyDesignException sde)
		{
			...
			if(studyDesignManager!=null)
			{
				...
				catch(BaseManagerException re) {categoryList = null;}					
			}
			categoryList = null;
		}								
		return categoryList;
	...
	{		
		...
		try
		{
			...
			{
				//Category.setStudyDesign(studyDesign);
			...
			{		
            	...
            	for(Category Category : categoryList)				
				{			
					System.out.println("in ServerResource id: "+Category.getId());
				}
     ...
     */
	@Delete("json")
	public List<Category> remove(StudyDesign studyDesign) 
	{
		boolean flag;	
		List<Category> categoryList = null;	
        try
        ...
        catch (BaseManagerException bme)
        {
            ...
            if (categoryManager != null) try { categoryManager.rollback(); } catch (BaseManagerException e) {}
            categoryList = null;           
        }
        catch (StudyDesignException sde)
        {
