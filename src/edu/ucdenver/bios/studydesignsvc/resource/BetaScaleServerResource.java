...
/**
 * Server Resource class for handling requests for the Beta Scale object. 
 * See the StudyDesignApplication class for URI mappings
 * 
 * @author Uttara Sakhadeo
 */
public class BetaScaleServerResource extends ServerResource 
implements BetaScaleResource 
{
	...
	public List<BetaScale> retrieve(byte[] uuid) 
	{
		...
		catch(StudyDesignException sde)
		{
			...
			if(studyDesignManager!=null)
			{
				...
				catch(BaseManagerException re) {betaScaleList = null;}					
			}
			betaScaleList = null;
		}								
	...
	{		
		...
		try
		{
			...
			{		
            	...
            	/*for(BetaScale betaScale : betaScaleList)				
				{			
					System.out.println("in ServerResource id: "+betaScale.getId());
				}*/
	...
	public List<BetaScale> remove(byte[] uuid) 
	{
		...
		{			
			...
			studyDesignManager.commit();
			/* ----------------------------------------------------
			 * Remove existing Beta Scale objects for this object 
			 * ----------------------------------------------------*/
	...
	public List<BetaScale> removeFrom(StudyDesign studyDesign) 
	{
        ...
        {                    			
        	betaScaleManager = new BetaScaleManager();
        	betaScaleManager.beginTransaction();
        		betaScaleList=betaScaleManager.delete(studyDesign.getUuid(),studyDesign.getBetaScaleList());
        	betaScaleManager.commit();
        	/* ----------------------------------------------------
			 * Set reference of BetaScale Object to Study Design object 
			 * ----------------------------------------------------*/
        ...
        catch (BaseManagerException bme)
        {
            ...
            if (betaScaleManager != null) try { betaScaleManager.rollback(); } catch (BaseManagerException e) {}
            betaScaleList = null;           
        }
        /*catch (StudyDesignException sde)
        {
