...
public class CovarianceManager extends BaseManager
{
	...
	public Set<Covariance> delete(byte[] uuidBytes,Set<Covariance> covarianceSet)
	{
		...
		catch(Exception e)
		{
			...
			throw new ResourceException(Status.CONNECTOR_ERROR_CONNECTION,"Failed to delete Covariance object for UUID '" + uuidBytes + "': " + e.getMessage());
		}
		return covarianceSet;
	}
	
	/**
     * Retrieve a Covariance object by the specified UUID.
     * 
     * @param covarianceSet : Set<Covariance>
     * @param isCreation : boolean
     * @return covarianceSet : Set<Covariance>
     */
	public Set<Covariance> saveOrUpdate(Set<Covariance> covarianceSet,boolean isCreation)
	{
		...
		catch(Exception e)
		{
			covarianceSet=null;
			System.out.println(e.getMessage());
			throw new ResourceException(Status.CONNECTOR_ERROR_CONNECTION,"Failed to save Covariance object : " + e.getMessage());
		}
		return covarianceSet;
	}
}
