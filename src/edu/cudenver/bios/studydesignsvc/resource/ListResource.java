...
/**
 * Resource for handling requests for all types of Lists.
 * Alpha List, Sample Size List, Test List etc.
   ...
   /**
    ...
    public Representation delete()
    {
        ...
        {	    	
	    	...
	    	response = new ListXMLRepresentation(namedList);
   ...
   @Put
    ...
    {    
        ...
        {           
        	...
        	ListXMLRepresentation response = new ListXMLRepresentation(namedList);
            getResponse().setEntity(response); 
            getResponse().setStatus(Status.SUCCESS_CREATED);
