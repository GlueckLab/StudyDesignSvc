 ...
 */
public class ListMatrixXMLRepresentation extends DomRepresentation
{
	/**
	 * Constructor
	 ...
	 * @throws IOException
	 */
	public ListMatrixXMLRepresentation(List<NamedRealMatrix> list,byte[] uuid) throws IOException 
	 {
     ...
     */
	public Element createListofListNodeElement(Document doc, List<NamedRealMatrix> list, byte[] uuid) 
    {
        ...
        for (NamedRealMatrix namedRealMatrix: list) 
        {
        	//GLMMPower glmmPower = (GLMMPower) power;
            //Element powerElem = GLMMPowerXMLRepresentation.createGLMMPowerElement(doc, glmmPower);
        	Element namedMatrixElem = MatrixXMLRepresentation.createMatrixNodeFromRealMatrix(doc, namedRealMatrix);
        	listElem.appendChild(namedMatrixElem);
        }
        return listElem;
    }
     ...
     * @return DOM node for a single power result
     */
	public static Element createListofListNodeElement(Document doc, List<NamedRealMatrix> list) 
    {
        ...
        for (NamedRealMatrix namedRealMatrix: list) 
        {
            ...
            //Element powerElem = GLMMPowerXMLRepresentation.createGLMMPowerElement(doc, glmmPower);
        	Element namedMatrixElem = MatrixXMLRepresentation.createMatrixNodeFromRealMatrix(doc, namedRealMatrix);
        	rootElem.appendChild(namedMatrixElem);
        }
        return rootElem;
    }
